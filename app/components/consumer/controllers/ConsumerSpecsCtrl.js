...
function($scope, $uibModal, $log, fileTransferService, specMarshallService,
    ...
    angular.module('ProxyPrint').controller('PageRangeController', ['$scope', '$uibModalInstance', 'usSpinnerService', 'pages',
    function ($scope, $uibModalInstance, usSpinnerService, pages) {
